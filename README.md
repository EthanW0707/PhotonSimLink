...
* **The Constraints:** The `skill.md` file and the `pVTS/` module structure included in this repository must remain in the root directory for the AI parameters to validate correctly.
...
4. Open the file drawer on the left side and upload `skill.md` along with the `pVTS/` folder directly into the main workspace folder.
